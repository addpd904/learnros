...
// (in-package servecommunicate.srv)
...
class mydataRequest {
  ...
  static serialize(obj, buffer, bufferOffset) {
    // Serializes a message object of type mydataRequest
  ...
  static deserialize(buffer, bufferOffset=[0]) {
    //deserializes a message object of type mydataRequest
    let len;
    let data = new mydataRequest(null);
  ...
  static Resolve(msg) {
    ...
    const resolved = new mydataRequest(null);
...
class mydataResponse {
  ...
  static serialize(obj, buffer, bufferOffset) {
    // Serializes a message object of type mydataResponse
  ...
  static deserialize(buffer, bufferOffset=[0]) {
    //deserializes a message object of type mydataResponse
    let len;
    let data = new mydataResponse(null);
  ...
  static Resolve(msg) {
    ...
    const resolved = new mydataResponse(null);
...
module.exports = {
  ...
  datatype() { return 'servecommunicate/mydata'; }
};
